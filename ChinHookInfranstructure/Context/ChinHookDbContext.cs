...
namespace ChinHookInfranstructure.Context
{
    public partial class ChinHookDbContext :  IdentityDbContext<ChinookUser>
    {

        public ChinHookDbContext(DbContextOptions<ChinHookDbContext> options)
        : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.Property(e => e.BirthDate).HasColumnType("DateTimeOffset");
                ...
                entity.Property(e => e.HireDate).HasColumnType("DateTimeOffset");
            ...
            modelBuilder.Entity<Invoice>(entity =>
            {
                ...
                entity.Property(e => e.InvoiceDate).HasColumnType("DateTimeOffset");
